...
#ifndef ObjectBaseScript_H
#define ObjectBaseScript_H
...
namespace Script
{
   ...
   class ObjectBaseScript : public QObject, public QScriptClass
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      ObjectBaseScript(QScriptEngine *pEngine);
      virtual ~ObjectBaseScript();
      ...
      virtual QScriptValue newInstance() = 0;
   ...
   protected:
      ...
      static QScriptValue toScriptValue(QScriptEngine *eng, const ObjectBaseWrapperPtr &pObj);
      static void fromScriptValue(const QScriptValue &obj, ObjectBaseWrapperPtr &pObj);
...
// ============================================================================
Q_DECLARE_METATYPE(Script::ObjectBaseScript*);

#endif // ObjectBaseScript_H
