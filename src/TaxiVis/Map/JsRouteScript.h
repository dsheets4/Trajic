...
#ifndef JsRouteScript_H
#define JsRouteScript_H
...
namespace Map
{
   ...
   class JsRouteScript : public Script::ObjectBaseScript
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      JsRouteScript(QScriptEngine *pEngine);
      virtual ~JsRouteScript();
   ...
   protected:
      ...
      // ----------------------------------------------------------------------
      void ConnectSignals(ObjectBaseWrapperPtr pJsRoute, ObjectBaseDispatchPtr pDispatch);
...
// ============================================================================
Q_DECLARE_METATYPE(Map::JsRouteScript*);

#endif // JsRouteScript_H
