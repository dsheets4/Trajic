...
#ifndef JsPointIconScript_H
#define JsPointIconScript_H
...
namespace Map
{
   ...
   class JsPointIconScript : public Script::ObjectBaseScript
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      JsPointIconScript(QScriptEngine *pEngine);
      virtual ~JsPointIconScript();
   ...
   protected:
      ...
      // ----------------------------------------------------------------------
      void ConnectSignals(ObjectBaseWrapperPtr pJsPointIcon, ObjectBaseDispatchPtr pDispatch);
...
// ============================================================================
Q_DECLARE_METATYPE(Map::JsPointIconScript*);

#endif // JsPointIconScript_H
