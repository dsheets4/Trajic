...
#ifndef JsPointScript_H
#define JsPointScript_H
...
namespace Map
{
   ...
   class JsPointScript : public Script::ObjectBaseScript
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      JsPointScript(QScriptEngine *pEngine);
      virtual ~JsPointScript();
   ...
   protected:
      ...
      // ----------------------------------------------------------------------
      void ConnectSignals(ObjectBaseWrapperPtr pJsPoint, ObjectBaseDispatchPtr pDispatch);
...
// ============================================================================
Q_DECLARE_METATYPE(Map::JsPointScript*);

#endif // JsPointScript_H
