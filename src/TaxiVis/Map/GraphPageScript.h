...
#ifndef GraphPageScript_H
#define GraphPageScript_H
...
namespace Map
{
   ...
   class GraphPageScript : public QObject, public QScriptClass
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      GraphPageScript(QScriptEngine *pEngine);
      virtual ~GraphPageScript();
...
// ============================================================================
Q_DECLARE_METATYPE(Map::GraphPageScript*);

#endif // GraphPageScript_H
