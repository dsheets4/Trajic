...
#ifndef GraphPieScript_H
#define GraphPieScript_H
...
namespace Vis
{
   //! Represents a GraphPieScript.
   class GraphPieScript : public GraphBaseScript
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      GraphPieScript(QScriptEngine *pEngine);
      virtual ~GraphPieScript();
...
// ============================================================================
Q_DECLARE_METATYPE(Vis::GraphPieScript*);

#endif // GraphPieScript_H
