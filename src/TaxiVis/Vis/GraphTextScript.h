...
#ifndef GraphTextScript_H
#define GraphTextScript_H
...
namespace Vis
{
   //! Represents a GraphTextScript.
   class GraphTextScript : public GraphBaseScript
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      GraphTextScript(QScriptEngine *pEngine);
      virtual ~GraphTextScript();
...
// ============================================================================
Q_DECLARE_METATYPE(Vis::GraphTextScript*);

#endif // GraphTextScript_H
