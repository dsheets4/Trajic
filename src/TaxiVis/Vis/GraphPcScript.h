...
#ifndef GraphPcScript_H
#define GraphPcScript_H
...
namespace Vis
{
   ...
   class GraphPcScript : public GraphBaseScript
   {
      Q_OBJECT
   ...
   public:
      ...
      // ----------------------------------------------------------------------
      GraphPcScript(QScriptEngine *pEngine);
      virtual ~GraphPcScript();
...
// ============================================================================
Q_DECLARE_METATYPE(Vis::GraphPcScript*);

#endif // GraphPcScript_H
