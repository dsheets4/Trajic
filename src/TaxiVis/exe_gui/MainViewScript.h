...
#ifndef MainViewScript_H
#define MainViewScript_H
...
class MainViewScript : public QObject, public QScriptClass
{
   Q_OBJECT
...
public:
   ...
   // ----------------------------------------------------------------------
   MainViewScript(QScriptEngine *pEngine);
...
// ============================================================================
Q_DECLARE_METATYPE(MainViewScript*);

#endif // MainViewScript_H
